...
const projectId = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID || "e08e99d213c331aa0fd00f625de06e66";
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    console.error = function() {
        ...
        if (errorMessage.includes("not found on Allowlist") || errorMessage.includes("Origin") || errorMessage.includes("Failed to fetch") || errorMessage.includes("403") || errorMessage.includes("Analytics SDK") || errorMessage.includes("Reown Config")) {
