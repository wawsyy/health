...
function MentalHealthSurveyApp() {
    ...
    const sameChainRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        "MentalHealthSurveyApp.useRef[sameChainRef]": (currentChainId)=>{
            return currentChainId === chainId;
        }
    }["MentalHealthSurveyApp.useRef[sameChainRef]"]);
    const sameSignerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        "MentalHealthSurveyApp.useRef[sameSignerRef]": (currentSigner)=>{
            // Simple check - in production you might want more sophisticated comparison
            return currentSigner !== undefined;
        }
    }["MentalHealthSurveyApp.useRef[sameSignerRef]"]);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Encrypt (this is CPU-intensive)
            const encrypted = await input.encrypt();
            if (!sameChainRef.current(chainId)) {
                setMessage("Chain changed during encryption. Please try again.");
                setLoading(false);
                return;
            }
            ...
            setMessage("Survey submitted successfully! Waiting for confirmation...");
            // Reset form
            setForm({
                stressLevel: "",
                anxietyLevel: "",
...
_s(MentalHealthSurveyApp, "w70LTH+V2vFQ8c7777DnzVXjXhU=", false, function() {
    return [
...
//# sourceMappingURL=frontend_28648ce4._.js.map